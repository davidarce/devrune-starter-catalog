...
Full orchestrator instructions: {SKILLS_PATH}/sdd-orchestrator/ORCHESTRATOR.md
...
1. You are in an active SDD workflow. Re-read the orchestrator instructions at `{SKILLS_PATH}/sdd-orchestrator/ORCHESTRATOR.md` — specifically the **Compaction Recovery Protocol** section.
